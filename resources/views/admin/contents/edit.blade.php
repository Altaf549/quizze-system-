            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('page_key') is-invalid @enderror" 
                        ...
                        <option value="about-us" {{ $content->page_key == 'about-us' ? 'selected' : '' }}>About Us</option>
                        <option value="privacy-policy" {{ $content->page_key == 'privacy-policy' ? 'selected' : '' }}>Privacy Policy</option>
                        <option value="terms-conditions" {{ $content->page_key == 'terms-conditions' ? 'selected' : '' }}>Terms & Conditions</option>
                    </select>
                    @error('page_key')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text text-muted">Choose the type of content you're editing</small>
                </div>
                <div class="col-md-6">
